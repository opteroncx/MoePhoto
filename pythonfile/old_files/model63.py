...
class Net(nn.Module):
    def __init__(self):
        ...
        self.relu = nn.PReLU()
        self.u1 = upsample_block(64,576)
        # self.u2 = upsample_block(64,256)
        self.ures1 = upsample_block(64,576)
        ...
        # self.GFF_1x1 = nn.Conv2d(64*5, 64, kernel_size=1, padding=0, bias=False)
        # self.GFF_3x3 = nn.Conv2d(64, 64, kernel_size=3, padding=1, bias=False)
    ...
    def forward(self, x):
        ...
        # FF = torch.cat((convt_F11, convt_F12, convt_F13, convt_F14, convt_F15), 1)
