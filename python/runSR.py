...
mode_switch = {
    ...
    'a-4': './model/gan/gan_x4.pth',
    'p2': './model/p2/model_new.pth',
    'p3': './model/p3/model_new.pth',
    'p4': './model/p4/model_new.pth',
    'p-4': './model/gan/gan_x4.pth',
}
ramCoef = .9 / np.array([10888.4, 4971.7, 2473., 24248.,
                         8253.9, 4698.7, 41951.3, 16788.7, 7029.7])
...
getModel = genGetModel(lambda opt, *args: models[opt.net_type+str(opt.scale)]())
