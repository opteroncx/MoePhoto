...
void ailut_transform_3d_cpu_forward_impl(
        const int n,
        const scalar_t* restrict data_inp,
        const scalar_t* restrict data_lut,
        const scalar_t* restrict data_anc,
        const int height,
        const int width,
        const int stride_lut,
        const int num_channels,
        scalar_t* restrict data_col) {
...
void ailut_transform_3d_cpu_backward_impl(
        ...
        const int stride_lut,
        const int num_channels,
        scalar_t* restrict grad_inp,
        scalar_t* restrict grad_lut,
        scalar_t* restrict grad_ver) {
